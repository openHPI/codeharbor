...
RSpec.describe FileTypesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested file_type as @file_type" do
      file_type = FileType.create! valid_attributes
      get :show, {:id => file_type.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested file_type as @file_type" do
      file_type = FileType.create! valid_attributes
      get :edit, {:id => file_type.to_param}, valid_session
      expect(assigns(:file_type)).to eq(file_type)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new FileType" do
        expect {
          post :create, {:file_type => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved file_type as @file_type" do
        post :create, {:file_type => invalid_attributes}, valid_session
        expect(assigns(:file_type)).to be_a_new(FileType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested file_type" do
        file_type = FileType.create! valid_attributes
        put :update, {:id => file_type.to_param, :file_type => new_attributes}, valid_session
        file_type.reload
      ...
      it "assigns the requested file_type as @file_type" do
        file_type = FileType.create! valid_attributes
        put :update, {:id => file_type.to_param, :file_type => valid_attributes}, valid_session
        expect(assigns(:file_type)).to eq(file_type)
      end
    ...
    context "with invalid params" do
      it "assigns the file_type as @file_type" do
        file_type = FileType.create! valid_attributes
        put :update, {:id => file_type.to_param, :file_type => invalid_attributes}, valid_session
        expect(assigns(:file_type)).to eq(file_type)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested file_type" do
      file_type = FileType.create! valid_attributes
      expect {
        delete :destroy, {:id => file_type.to_param}, valid_session
      }.to change(FileType, :count).by(-1)
    end
