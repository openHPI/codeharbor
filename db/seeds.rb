...
Label.create(name: 'Java', color: '58FA58', label_category: category1, exercise: exercise)
Label.create(name: 'basic', color: 'DF0101', label_category: category2, exercise: exercise)
Label.create(name: 'pupil', color: 'F7FE2E', label_category: category3, exercise: exercise)